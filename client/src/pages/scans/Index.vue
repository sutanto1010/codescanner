    ...
    <v-card>
      <v-card-text>
        ...
        >
          ...
          <template v-slot:[`item.scan_start`]="{ item }">
            {{ item.scan_start | formatDate("YYYY-MM-DD HH:mm:ss", true) }}
          </template>
          <template v-slot:[`item.scan_end`]="{ item }">
            {{ item.scan_end | formatDate("YYYY-MM-DD HH:mm:ss", true) }}
          </template>
        </arch-data-table>
      </v-card-text>
    </v-card>
